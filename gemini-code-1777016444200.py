...
if files:
    ...
    # 這裡的關鍵是在所有出現中文的地方加上 fontproperties=font_prop
    with col1:
    ...
    with col2:
        ...
        ax2.set_title("舞弊與倒閉預測", fontproperties=font_prop)
    ...
    doc.save(doc_buf)
    doc_buf.seek(0)
    st.sidebar.download_button("下載 Word 報告", doc_buf, f"{co_name}_報告.docx")

else:
    st.info("請完成資訊填寫並上傳檔案")
